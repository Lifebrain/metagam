...
We can also get the result of significance testing at the alpha level provided. `TRUE` means "Reject H0", `FALSE` means "Don't reject H0".

```{r}
meta_analysis$meta_test
```
