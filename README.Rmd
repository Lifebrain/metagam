...
<!-- badges: start -->
[![Travis build status](https://travis-ci.org/osorensen/metagam.svg?branch=master)](https://travis-ci.org/osorensen/metagam)
<!-- badges: end -->


`metagam` is an R-package for flexible meta-analysis of generalized additive (mixed) models (GAMs/GAMMs).

The package is under development, so changes to the interface can be expected. Suggestions for improvements and bug reports are warmly welcome, either by filing an [Issue](https://github.com/osorensen/metagam/issues) or opening a [Pull Request](https://github.com/osorensen/metagam/pulls).
