...
Installation with [BiocManager](https://cran.r-project.org/package=BiocManager) is necessary because `metagam` depends on the [Bioconductor](https://www.bioconductor.org/) package [multtest](https://www.bioconductor.org/packages/multtest/). 
